...
export function summarizeFrontalRunningFrames(
  ...
  return {
    modality: 'running',
    view: 'frontal',
    pelvicObliquityDeg: pelvicDropDeg,
...
export function makeFrontalCyclingDemoSummary(): FrontalCyclingSummary {
  ...
  return {
    modality: 'cycling',
    view: 'frontal',
    kneeLateralExcursionLeftMm: 10.7,
    kneeLateralExcursionRightMm: 12.3,
    pelvicRockingDeg: 5.7,
    linearScale: 'assumed-pelvic-width',
...
export function makeFrontalRunningDemoSummary(): FrontalRunningSummary {
  ...
  return {
    modality: 'running',
    view: 'frontal',
    pelvicObliquityDeg: 7.3,
    contralateralPelvicDropDeg: 7.3,
    dynamicKneeValgusLeftDeg: 3.4,
    dynamicKneeValgusRightDeg: 3.4,
    stepWidthRatio: 0.9,
